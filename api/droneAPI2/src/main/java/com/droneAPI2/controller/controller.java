...
public class controller {
		...
		public ResponseEntity<Object> adduser(@Valid @RequestBody users user) 
	{
			...
			public ResponseEntity<Object> addlibrary(@Valid @RequestBody library lib) 
		{
			...
			@PutMapping("/coordinates/{cid}")
			public ResponseEntity<Object> insertUpdateCoordinates(@RequestBody coordinatesModel coords, @PathVariable int cid)
			{
				...
				{
					coordinatesModel latlong = cRepo.save(coords);
